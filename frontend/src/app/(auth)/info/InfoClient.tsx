...
import { Mail, Clock, ArrowDown, CheckCircle } from 'lucide-react';
import {
    Card,
    CardContent,
    CardDescription,
...
const InfoPage = () => {
    ...
    const { isLoading, error, resetMessage } = useSelector((state: RootState) => state.auth);
