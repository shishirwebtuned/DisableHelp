        ...
        <div className="min-h-screen bg-gray-50 dark:bg-slate-950">
            <div className="container mx-auto">
                ...
                <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-xl sm:text-xl font-bold mb-2">My Profile {id}</h1>
                    ...
                    <div className="lg:col-span-3">
                        <Card>
                            ...
                            <CardContent className="pt-4 sm:pt-6 px-3 sm:px-6">
                                <div className="max-h-[calc(100vh-20rem)] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 dark:scrollbar-thumb-gray-600 dark:scrollbar-track-gray-800">
                                    {renderSection()}
                                </div>
                            </CardContent>
                        </Card>
